This repository contains the code for Efficient Federated Unlearning under Plausible Deniability with custom ResNet-7 model architecture (we call ResNet-mini).
