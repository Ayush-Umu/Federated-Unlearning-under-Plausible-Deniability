This repository contains the code for Efficient Federated Unlearning under Plausible Deniability with custom convolution network (ConvNet) which consists of two convolution layers 
